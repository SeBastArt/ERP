...
{
    /// <summary>
    /// ArticleInventoryApiConvention
    /// </summary>
    public static class ArticleInventoryApiConvention
    {
        /// <summary>
        /// Get
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ApiResult<ArticleInventoryResponse>), StatusCodes.Status200OK)]
        ...
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ArticleInventoryResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
        ...
        [ProducesResponseType(typeof(RespContainer<ArticleInventoryResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
