...
{
    /// <summary>
    /// CountryApiConvention
    /// </summary>
    public static class CountryApiConvention
    {
        /// <summary>
        /// Get
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ApiResult<CountryResponse>), StatusCodes.Status200OK)]
        ...
        [ProducesResponseType(typeof(RespContainer<CountryResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
