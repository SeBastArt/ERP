...
namespace ERP.Domain.Responses
{
    public class ArticleResponse : BaseResponse
    {
        ...
        public ArticleGroupResponse ArticleGroup { get; set; }
        public Guid ArticleTypeId { get; set; }
        public ArticleTypeResponse ArticleType { get; set; }
        public ICollection<ArticleInventoryResponse> ArticleInventories { get; set; }
        public ICollection<ArticleRangeResponse> ArticleRanges { get; set; }
        public ICollection<FAGBinaryResponse> Pictures { get; set; }
    }
}
