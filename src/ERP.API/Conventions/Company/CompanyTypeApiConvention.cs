...
{
    /// <summary>
    /// CompanyTypeApiConvention
    /// </summary>
    public static class CompanyTypeApiConvention
    {
        /// <summary>
        /// Get
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ApiResult<CompanyTypeResponse>), StatusCodes.Status200OK)]
        ...
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(CompanyTypeResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
        ...
        [ProducesResponseType(typeof(RespContainer<CompanyTypeResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
