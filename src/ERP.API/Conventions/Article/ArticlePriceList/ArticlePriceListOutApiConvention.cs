...
{
    /// <summary>
    /// ArticlePriceListOutApiConvention
    /// </summary>
    public static class ArticlePriceListOutApiConvention
    {
        /// <summary>
        /// Get
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ApiResult<ArticlePriceListOutResponse>), StatusCodes.Status200OK)]
        ...
        /// </summary>
        /// <param name="id"></param>
        [ProducesResponseType(typeof(ArticlePriceListOutResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
        ...
        [ProducesResponseType(typeof(RespContainer<ArticlePriceListOutResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status403Forbidden)]
        [ProducesResponseType(typeof(RespContainer<JsonException>), StatusCodes.Status404NotFound)]
        [ApiConventionNameMatch(ApiConventionNameMatchBehavior.Prefix)]
